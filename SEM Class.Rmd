...
$\hspace{1cm}$ The report was written with R markdown. The file can be found on my GitHub with all the code in R [@r2021] and analyses available (). I have also included a \textit{sessionInfo} file with the package versions.
...
$\hspace{1cm}$ The current study contributes to the literature on the impact of school climate on minority students' experiences. In particular, our findings highlight the complex interplay between diversity climate, peer rejection, school belonging, and self-esteem among minorities in the Flemish context. This has several important implications for research and educational practices.

$\hspace{1cm}$ Our findings supported most of the hypotheses. More specifically, this report shows the importance of a positive diversity climate for minority students' sense of school belonging (Hypothesis 1), reduced experiences of peer rejection (Hypothesis 2), and improved self-esteem (Hypothesis 3). This aligns with previous research that showed how a positive and inclusive diversity climate may foster feelings of acceptance, decrease discriminatory experiences, and promote positive self-concept among minority students (Moreu et al., 2021). The analyses also showed that school belonging plays a significant role in promoting self-esteem (Hypothesis 4). However, peer rejection does not seem to harm self-esteem, which did not support hypothesis 5. Interestingly, this latter aspect may be connected with the literature on rejection-identification theory [@armenta2009responding; @wellman2022identifying]. That said, individuals who perceive high levels of social rejection due to their group membership may strengthen their identification with their own-group. This increased group identification is responsible for providing a buffer against the negative effects of social rejection on self-esteem.

$\hspace{1cm}$ Still, peer rejection may have an effect in other ways, such as leading to lower sense of school belonging for minorities (Hypothesis 6). This finding highlights the potentially harmful effects of exclusionary experiences on students' connection to their school environment. Importantly, the mediation analyses shed light on the mechanisms through which diversity climate might affect self-esteem. Furthermore, the impact of diversity climate on self-esteem appears to be partially mediated by school belonging (Hypothesis 7). This shows the vital role of an inclusive school environment in promoting self-esteem among minority students. However, hypothesis 8, which suggests that the impact of diversity climate on self-esteem is mediated by peer rejection, was not supported. This indicates that, while a positive diversity climate is associated with less peer rejection, this does not necessarily translate into higher self-esteem. Lastly, hypothesis 9, which proposed that the impact of peer rejection on self-esteem is mediated by school belonging, was supported. This suggests that, even in the face of peer rejection, fostering a sense of school belonging can still induce minority students' self-esteem.

$\hspace{1cm}$ These results have significant implications for educators and policies. With this report, the findings show that it is crucial to provide an inclusive and supportive school diversity climate that not only minimizes peer rejection, but also promotes a sense of belonging. In that way, we can enhance self-esteem and overall well-being among minority students. 

$\hspace{1cm}$ Moreover, further research is needed to fully elucidate the relationships and potential interventions explored in this study. In fact, this report comes with limitations. One may argue that the cross-sectional design precludes conclusions about causality. Another limitation is that this analyses did not include the school clusters as a higher level in the model. Lastly, the school climate analyzed in this report solely focused on the minorities' experience instead of the overall students' perception.
